...
from .models import Client as ClientCommande
...
class ClientModelTest(TestCase):
    ...
    def test_email_unique(self):
        ...
        ClientCommande.objects.create(
            prenom="Jean", nom="Dupont", email="test@example.com"
        )

        with self.assertRaises(IntegrityError):
            ClientCommande.objects.create(
                prenom="Marie", nom="Martin", email="test@example.com"
            )
...
class CommandeModelTest(TestCase):
    ...
    def test_génération_code_accès_unique(self):
        ...
        commande1 = Commande.objects.create(
            client=self.client, titre="Commande 1", expire_le=self.expire_le
        )
        commande2 = Commande.objects.create(
            client=self.client, titre="Commande 2", expire_le=self.expire_le
        )
    ...
    def test_enregistrer_visite(self):
        ...
        commande = Commande.objects.create(
            client=self.client, titre="Test", expire_le=self.expire_le
        )
    ...
    def test_str_representation(self):
        ...
        commande = Commande.objects.create(
            client=self.client, titre="Ma Commande", expire_le=self.expire_le
        )
...
class PhotoCommandeModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.galerie = Galerie.objects.create(
            nom="Test Galerie", slug="test", description="Test"
        )
        ...
        self.version = PhotoVersion.objects.create(
            photo=self.photo, traitement="couleur", largeur=1920, hauteur=1080
        )
    ...
    def test_get_titre_affichage_sans_titre_personnalise(self):
        ...
        self.assertEqual(
            photo_commande.get_titre_affichage(), self.photo.get_titre_affichage()
        )
...
class CommandeViewsTest(TestCase):
    ...
    def test_acces_commande_valide(self):
        ...
        url = reverse(
            "commandes:acces_commande", kwargs={"code_acces": self.commande.code_acces}
        )
    ...
    def test_acces_commande_code_invalide(self):
        ...
        url = reverse(
            "commandes:acces_commande", kwargs={"code_acces": "code-invalide"}
        )
        response = self.client_http.get(url)
    ...
    def test_acces_commande_expiree(self):
        ...
        url = reverse(
            "commandes:acces_commande",
            kwargs={"code_acces": commande_expiree.code_acces},
        )
        response = self.client_http.get(url)
    ...
    def test_acces_commande_en_preparation(self):
        ...
        url = reverse(
            "commandes:acces_commande", kwargs={"code_acces": commande_prep.code_acces}
        )
        response = self.client_http.get(url)
    ...
    def test_photo_detail_commande(self):
        ...
        url = reverse(
            "commandes:photo_detail_commande",
            kwargs={
    ...
    def test_aide_commande(self):
        ...
        url = reverse(
            "commandes:aide_commande", kwargs={"code_acces": self.commande.code_acces}
        )
        response = self.client_http.get(url)
