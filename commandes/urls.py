...
urlpatterns = [
    ...
    path(
        "acces/<str:code_acces>/photo/<int:photo_id>/",
        views.photo_detail_commande,
        name="photo_detail_commande",
    ),
    # Téléchargement d'une photo individuelle
    path(
        "acces/<str:code_acces>/photo/<int:photo_id>/telecharger/",
        views.telecharger_photo,
        name="telecharger_photo",
    ),
    # Téléchargement de toutes les photos en ZIP
    path(
        "acces/<str:code_acces>/telecharger-tout/",
        views.telecharger_toutes_photos,
        name="telecharger_toutes_photos",
    ),
    # Page d'aide
