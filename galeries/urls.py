...
urlpatterns = [
    ...
    path(
        "galerie/prive/<slug:galerie_slug>/telecharger-zip/",
        views.telecharger_galerie_zip,
        name="telecharger_galerie_zip",
    ),
    path(
        "galerie/prive/<slug:galerie_slug>/",
        views.galerie_privee,
        name="galerie_privee",
    ),
    path(
        "galerie/prive/<slug:galerie_slug>/<slug:collection_slug>/",
        views.collection_privee,
        name="collection_privee",
    ),
    ...
    path(
        "galerie/<slug:galerie_slug>/<slug:collection_slug>/",
