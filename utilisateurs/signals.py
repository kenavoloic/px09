...
def creer_profil_utilisateur(sender: object, instance: Utilisateur, created: bool, **kwargs: object) -> None:
    """
...
@receiver(post_save, sender=Utilisateur)
def synchroniser_profil_utilisateur(sender: object, instance: Utilisateur, created: bool, **kwargs: object) -> None:
    """
    ...
    if not created:  # Seulement pour les mises à jour
        ...
        if instance.role == Utilisateur.Role.PHOTOGRAPHE:
            if not hasattr(instance, 'profil_photographe') or not instance.profil_photographe:
